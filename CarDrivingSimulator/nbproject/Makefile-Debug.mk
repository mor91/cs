...
${OBJECTDIR}/AddCarEvent.o: AddCarEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AddCarEvent.o AddCarEvent.cpp
...
${OBJECTDIR}/CarFaultEvent.o: CarFaultEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CarFaultEvent.o CarFaultEvent.cpp

${OBJECTDIR}/CarReport.o: CarReport.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CarReport.o CarReport.cpp
...
${OBJECTDIR}/Junction.o: Junction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Junction.o Junction.cpp

${OBJECTDIR}/JunctionReport.o: JunctionReport.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JunctionReport.o JunctionReport.cpp

${OBJECTDIR}/Report.o: Report.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Report.o Report.cpp
...
${OBJECTDIR}/RoadReport.o: RoadReport.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RoadReport.o RoadReport.cpp

${OBJECTDIR}/ini.o: ini.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ini.o ini.cpp
